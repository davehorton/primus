...
public class Lot implements java.io.Serializable {
	...
	private BigDecimal apiActiveSetting;
	...
	public Lot(BigDecimal lotId, ServiceProvider serviceProvider,
			...
			char allowPinOnlyLoginFlag, BigDecimal apiActiveSetting) {
		this.lotId = lotId;
		...
		this.apiActiveSetting = apiActiveSetting;
	}
	...
	public Lot(BigDecimal lotId, ServiceProvider serviceProvider,
			...
			char allowPinOnlyLoginFlag, BigDecimal apiActiveSetting,
			Set evtPrepaidActivations, Set preActivatedSubscriberses) {
		this.lotId = lotId;
		this.serviceProvider = serviceProvider;
		this.productOffering = productOffering;
		this.createdDate = createdDate;
	...
	public BigDecimal getApiActiveSetting() {
		return this.apiActiveSetting;
	}

	public void setApiActiveSetting(BigDecimal apiActiveSetting) {
		this.apiActiveSetting = apiActiveSetting;
	}
