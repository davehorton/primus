...
public class AccessNumber implements java.io.Serializable {
	...
	public AccessNumber(BigDecimal accessNumberId, String accessNumber,
			BigDecimal status, char domIntlFlag, char acdEnabled,
	...
	public AccessNumber(BigDecimal accessNumberId, LanguageRef languageRef,
			...
			BigDecimal accessNumberGroupId, BigDecimal prepaidCardNumberLength,
